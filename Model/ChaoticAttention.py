...
if __name__ == "__main__":
    ...
    CAttention = ChaoticAttention(inputSize = 28, hiddenSize = 20, Lee = Lee)
    ...
    CAttention = ChaoticAttention(inputSize = 28, hiddenSize = 20, Lee = Lee, chaotic = False)
    ...
    # Create the normal Attention Mechanism.
    CAttention = ChaoticAttention(inputSize = 24, hiddenSize = 20, Lee = Lee, chaotic = False)
    # Test the normal Attention Mechanism.
    x = torch.randn((32, 9, 20))
    hidden = (torch.zeros((32, 4)), torch.zeros((32, 4)), torch.zeros((32, 4)), torch.zeros((32, 4)))
